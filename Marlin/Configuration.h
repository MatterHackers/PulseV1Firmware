...
#define ExtruderType    1    // 1 = EZR, 2 = Bondtech QR 1.75mm, 3 = Bondtech QR 3mm, 4 = Bondtech BMG, 5 = LDO Orbiter 1.75mm
...
#define STRING_CONFIG_H_AUTHOR "(Pulse)" // Who made the changes.
...
#if HotEndType == 2 || HotEndType == 3 || HotEndType == 4 
  #define PREHEAT_4_LABEL "NylonX"
